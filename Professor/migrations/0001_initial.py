# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-12-10 10:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_poll_id', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avg', models.FloatField(blank=True, default=0, null=True)),
                ('number_of_responses', models.IntegerField(blank=True, default=0, null=True)),
                ('conduct_quiz_id', models.CharField(blank=True, max_length=50, null=True)),
                ('quiz_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Professor.ConductQuiz')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='conductpoll',
            name='poll',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Professor.Poll'),
        ),
    ]
